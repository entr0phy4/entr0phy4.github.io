...
export const sections = [
  ...
  },
  {
    ...
    child: [
      { id: 'base-system', title: 'Base system', child: [
      ...
      { id: 'system-requirements', title: 'System requirements', child: [
      ...
      { id: 'partitioning', title: 'Partitioning', child: [
        { id: 'add-new-disk', title: 'Add new disk' },
        { id: 'create-gpt-partition-table', title: 'Create GPT partition table' },
      ...
      { id: 'base-system-packages', title: 'Base system packages', child: [
        { id: 'download-packages', title: 'Download packages' },
        { id: 'verify-downloaded-packages', title: 'Verify downloaded packages', child: [
          { id: 'fix-expat-2.6.4-error', title: 'Fix expat 2.6.4 error' },
        ] },
      ] },
      { id: 'final-preparations', title: 'Final preparations', child: [
  ...
  },
  {
    ...
    child: [
      { id: 'installing-lfs', title: 'Installing LFS' },
    ],
  },
]
